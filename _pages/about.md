...
欢迎来到我的主页！我是陈乐知，四川大学本科生，目前在北京大学定量生物学中心实习，在[周沛劼老师](https://cqb.pku.edu.cn/info/1002/2869.htm)的指导下进行单细胞时空动力学重建、最优传输相关研究。我还曾在四川大学人工智能学院进行科研训练，在[琚玮老师](https://juweipku.github.io/)的指导下研究图神经网络、深度图聚类。

我的研究主要围绕生物学问题，从计算与理论两方面展开：在计算方面，我主要开发**机器学习**（如生成模型、图神经网络）算法来挖掘与分析大规模生物学数据（如高通量组学数据）；在理论方面，我致力于从**统计物理**（如复杂网络）和**应用数学**（如最优传输）的视角来建模生物学过程。我的目标是汲取计算与理论两方面的智慧，开展数据-机理融合的<span style="color:purple; font-weight:bold;">计算系统生物学</span>研究，构建虚拟细胞来进行in silico实验，探索胚胎发育与细胞命运决定背后的机理。

日常生活中，我喜欢推galgame（喜欢剧情作），jrpg（喜欢由rpgmaker制作的重剧情的rpg，如Demons Roots、阿尔米奥西翁的医术师）和看动漫（最喜欢路人女主的养成方法）。

如果你也对上述领域感兴趣，非常欢迎随时联系，我非常喜欢和不同背景的科研工作者交流学习！
