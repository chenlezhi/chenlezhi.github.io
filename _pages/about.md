...
My research interests center on hybrid modeling of complex systems. Specifically, I am working on developing scalable and actionable computational methods (primarily based on **machine learning**), while incorporating insights from **statistical physics** (e.g. nonequilibrium thermodynamics) and **applied mathematics** (e.g. dynamical systems, stochastic processes) to gain a deeper understanding of living systems.
