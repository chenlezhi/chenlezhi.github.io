...
我当前的研究兴趣主要围绕生物学问题，从计算与理论两方面展开：在计算方面，我主要关心**机器学习**（如生成模型、图神经网络）在挖掘与分析大规模生物学数据中的应用；在理论方面，我致力于从**统计物理**（如复杂网络）和**应用数学**（如最优传输）的视角来建模生物学过程。我的目标是汲取这两方面的智慧，开展<span style="color:purple; font-weight:bold;">数据-机理融合的计算系统生物学</span>研究，探索细胞发育与命运决定背后的机理。
